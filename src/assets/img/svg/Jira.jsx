export function LogosJira(props) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient
          id="IconifyId19ac12d6e39eafe450"
          x1="98.031%"
          x2="58.888%"
          y1=".161%"
          y2="40.766%"
        ...
        <linearGradient
          id="IconifyId19ac12d6e39eafe451"
          x1="100.665%"
          x2="55.402%"
          y1=".455%"
          y2="44.727%"
      ...
      />
      <path
        fill="url(#IconifyId19ac12d6e39eafe450)"
      ...
      />
      <path
        fill="url(#IconifyId19ac12d6e39eafe451)"
